...
Uygulama açıldığında macOS güvenlik hazırlığı penceresi gösterirse, zipten çıkan
LLMExtractor-...-macos-arm64 üst klasörünü seçin. Uygulama gerekli hazırlığı
Terminal kullanmadan kendisi yapar ve aynı klasörden yeniden açılır.

Eğer macOS uygulamayı hiç açtırmazsa veya uygulama içi hazırlık başarısız olursa
son çare olarak Terminal uygulamasında şu komutu çalıştırabilirsiniz. Komuttaki
KLASOR_YOLU yerine zipten çıkan LLMExtractor-...-macos-arm64 klasörünün gerçek
yolunu yazın veya bu klasörü Terminal penceresine sürükleyip bırakın:

xattr -dr com.apple.quarantine KLASOR_YOLU

Örnek:

xattr -dr com.apple.quarantine "$HOME/Downloads/LLMExtractor-0.1.0-early.9-macos-arm64"
